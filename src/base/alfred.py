...
class Alfred:
    ...
    def add_item(self,title, subtitle, arg, valid=True,icon=None, match=None, quicklookurl=None, *args, **kwargs):
        _item = Alfred_Item(
            title=title,
            subtitle=subtitle,
            match="{} {}".format(title, subtitle) if match is None else match,
            arg=arg,
            icon=icon,
            valid=valid,
